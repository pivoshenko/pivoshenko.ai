...
The refuse-list (hype, vague value, filler) and the rhythm rules live in `SKILL.md`'s draft step. This file adds the tells specific to generated prose. Pattern: **Don't · Why it fails · The move.**
...
- **Don't:** "In this post, we'll explore...", "Have you ever wondered...", restating the title in three sentences
...
- **The move:** delete the first paragraph. Start at the first concrete fact or the sharpest claim. If the second paragraph works as an opener, the first was filler

### The Summary Outro

- **Don't:** "In conclusion...", "Ultimately...", "The key takeaway is...", a bullet recap of the sections above
...
- **Don't:** Five sections of near-equal length, each with an intro sentence, three bullets, and a wrap-up line
...
- **Don't:** "Introduction", "Background", "Conclusion", "Final Thoughts", "Wrapping Up"
...
- **Don't:** Bullets restating one idea three ways; numbered lists where order carries no meaning
...
- **Don't:** "This isn't just a config change - it's a mindset shift."
...
- **Don't:** "Faster, cleaner, and more maintainable." Three parallel examples. Three-adjective stacks, everywhere
...
- **Don't:** "can potentially help", "might be worth considering", "in some cases, this could"
...
- **Don't:** "Moreover... Furthermore... Additionally... That said..."
...
- **Don't:** "Whether you're a beginner or a seasoned expert...", "there are pros and cons to each approach", ending analysis with "it depends"
...
- **Don't:** "Some might argue...", "many developers feel...", "it's often said that..."
...
- **Don't:** "I updated the configuration to enable stricter checking" - with no config shown
...
Deleting the tells leaves a hole; this is what fills it. Every section must contain at least one artifact that could only come from the author:
