<!--
=== CONTRIBUTING.md ===
Purpose:  Lands at repository root. Language-agnostic contributor guide covering bug reports, enhancement requests, branches, commits, pull requests. Conventional Commits + rebase-only workflow.
Tokens:   none
Override: Add a "### Language setup" subsection under "Local Development" with stack-specific commands. Do not weaken the Conventional Commits requirement or the rebase-only flow — both are canon.
=== end ===
-->
