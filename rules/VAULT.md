...
| `97 MEMORY/` | **Canonical** Claude Code memory, one subfolder per project; `~/.claude/projects/<slug>/memory` is a real-dir mirror (no symlinks) refreshed after memory writes | harness format |
