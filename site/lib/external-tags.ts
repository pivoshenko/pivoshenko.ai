export const SKILL_TAGS: Record<string, string[]> = {
  ...
  pptx: ['docs'],
  'skill-creator': ['meta'],
  'next-dev-loop': ['nextjs', 'frontend'],
  'next-cache-components-adoption': ['nextjs', 'frontend'],
  'next-cache-components-optimizer': ['nextjs', 'perf'],
  'codebase-design': ['engineering', 'design'],
  implement: ['engineering'],
  handoff: ['engineering', 'agents'],
